        ...
        <View testID="login-form" style={styles.form}>
          ...
          >
            <Text style={{ color: c.textSecondary, fontSize: 13 }}>
              No account?{" "}
              <Text style={{ color: c.textPrimary, fontWeight: "700" }}>Create one</Text>
            </Text>
          </TouchableOpacity>

          {/* Divider */}
          <View style={[styles.divider, { backgroundColor: c.border, marginVertical: 24 }]} />

          <Text style={{ color: c.textSecondary, fontSize: 12, marginBottom: 12, fontWeight: "700", letterSpacing: 1 }}>
            OTHER OPTIONS
          </Text>
          ...
          <TouchableOpacity
            testID="login-otp"
            style={[styles.ghostBtn, { borderColor: c.border, backgroundColor: c.surface, marginBottom: 10 }]}
            onPress={() => router.push("/login-otp")}
          >
            <Ionicons name="phone-portrait-outline" size={18} color={c.textPrimary} />
            <Text style={{ color: c.textPrimary, fontSize: 15, fontWeight: "600", marginLeft: 8 }}>
              Sign In with OTP
            </Text>
          </TouchableOpacity>

          {/* Google Login — stub until native build is configured */}
          <TouchableOpacity
            testID="login-google"
